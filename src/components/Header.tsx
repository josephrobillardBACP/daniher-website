        ...
        <div className="flex items-center justify-between h-24 sm:h-24 md:h-24">
          <Link to="/" onClick={(e) => handleNavClick(e, '/')} className="shrink-0">
            <img
              ...
              className="h-16 sm:h-16 md:h-[5.2rem] w-auto object-contain"
            />
          </Link>
          ...
          <nav className="hidden lg:flex items-center gap-14 xl:gap-16">
            ...
            >
              <Link
                ...
                className={`${linkBase} inline-flex items-center gap-1 ${isActive('/about') || isActive('/team') || isActive('/dr-daniher') ? activeStyle : ''}`}
              >
                About Us
